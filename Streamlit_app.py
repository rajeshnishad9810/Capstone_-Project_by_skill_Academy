...
cleaned_data = pd.read_csv('https://github.com/rajeshnishad9810/Capstone_-Project_by_skill_Academy/blob/main/Car_Details_Cleaned_Dataset.csv')
...
image_path = "https://github.com/rajeshnishad9810/Capstone_-Project_by_skill_Academy/blob/main/automotive.jpg?raw=true"
st.markdown(
    f"""
    <style>
    .header {{
